                ...
                <form onSubmit={handleSubmit(onSubmit)} className="newUserForm">
                    <div className='newUserFormContainer1'>
                        <div className='newUserFormData'>
                            <div className='flex flex-col items-start justify-center'>
                                ...
                                <input {...register} required placeholder="Tu nombre" id="name" type="text"
                            ...
                            <div className='flex flex-col items-start justify-center'>
                                ...
                                <input {...register} required placeholder="18" id="age" type="number" min="18"
                                max="99" className='mt-2 bg-white/90 rounded-md p-2 shadow-sm w-10 text-sm'/>
                            </div>
                        </div>
                        <div className='newUserFormGender'>
                            <div className='flex flex-col items-start justify-center'>
                                ...
                                <select {...register} required id="gender" className='mt-2 bg-white/90
                            ...
                            <div className='flex flex-col items-start justify-center'>
                                ...
                                <select {...register} required id="genderInterest" className='mt-2 bg-white/90
                                rounded-md p-2 shadow-sm w-[205px] text-sm' defaultValue="default">
                                    <option value="default" disabled>Opciones</option>
                        ...
                        <div className='newUserFormEmailPassword'>
                            <div className='flex flex-col items-start justify-center mt-1'>
                                ...
                                <input {...register} required placeholder="Tu email" id="email" type="email"
                                className='mt-2 bg-white/90 rounded-md p-2 shadow-sm w-[205px] text-sm'/>
                            </div>
                            <div className='flex flex-col items-start justify-center mt-1'>
                                ...
                                <input {...register} required placeholder="Tu contraseña" id="password"
                    ...
                    <div className="newUserFormContainer2">
                        ...
                        <div className="newUserFormImages">
                            ...
                            <input {...register} required type="file" id="img1"
                            accept=".jpg,.jpeg,.png" name='picture' className="hidden"/>
                            <label htmlFor="img2" className='relative aspect-[4/5] bg-[#e0d4d4] w-24
                            rounded-lg cursor-pointer border-2 border-[#E87C7C] border-dashed'>
                                <FaTimesCircle size={18} className="bg-[#FFEAEA] text-[#ed3434]
                                rotate-45 rounded-full absolute -bottom-1 -right-1" />
                            </label>
                            <input {...register} required type="file" id="img2"
                            accept=".jpg,.jpeg,.png" name='picture' className="hidden"/>
                            ...
                            <input {...register} required type="file" id="img3"
                            accept=".jpg,.jpeg,.png" name='picture' className="hidden"/>
                            ...
                            <input {...register} required type="file" id="img4"
                            accept=".jpg,.jpeg,.png" name='picture' className="hidden"/>
                        </div>
                        ...
                        <div className='newUserFormDesc'>
                            ...
                            <textarea {...register} required maxLength={500}
                            placeholder="Cuéntanos un poco sobre tí" id="description" className='mt-2 bg-white/90
                            rounded-md p-2 w-72 sm:w-80 h-36 shadow-sm text-sm'/>
                        </div>
                    </div>
