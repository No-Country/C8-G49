...
import { FaHeart, FaCommentAlt, FaGrinHearts } from 'react-icons/fa';
import { Link } from 'react-router-dom';

const MobileFooter = () => {
    return (
        <div className='w-full flex items-center justify-between bg-[#FF929D] px-10 py-5 sm:px-44 mt-3'>
            <Link to="/">
            ...
            <Link to="/">
                <FaGrinHearts size={35} className="cursor-pointer text-[#FFEAEA] sideBarIcon" />
            </Link>
