...
const MatchesAndChats = ({messagesState, matchesState, setMatchesState, setMessagesState}: Props) => {
    ...
    {matchesState ?
    <div className="grid grid-cols-2 w-full gap-4 px-6 py-4 place-content-start bg-white h-[20.5rem]
    ...
    scrollbar-track-[#ed3434]/30 scrollbar-thumb-[#ed3434]/90">
        <div className="p-[0.225rem] rounded-lg gradientBgMatches matchesAndChatsBox cursor-pointer">
            <div className="grid place-items-center p-2 rounded-md bg-white transition-colors">
